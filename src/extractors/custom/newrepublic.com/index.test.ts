...
describe('NewrepublicComExtractor', () => {
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html = fs.readFileSync('./fixtures/newrepublic.com.html', 'utf-8');
    ...
    it('article returns the title', async () => {
      ...
      // the article.
      assert.strictEqual(title, 'Fantastic Beasts: A Nice Place to Visit');
    });
    ...
    it('returns the author', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.strictEqual(author, 'Will Leitch');
    });
  ...
  describe('minutes', () => {
    ...
    beforeAll(async () => {
      ...
      const html = fs.readFileSync(
        './fixtures/newrepublic.com--minutes.html',
        'utf-8'
      );
    ...
    it('article returns the author', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.strictEqual(author, 'Alex Shephard');
    });
