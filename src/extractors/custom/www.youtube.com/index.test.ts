...
describe('WwwYoutubeComExtractor', () => {
  describe('initial test case', () => {
    ...
    it('returns the title', async () => {
      ...
      // the article.
      assert.strictEqual(title, 'ElixirConf 2016 - Keynote by José Valim');
    });
    ...
    it('returns the author', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.strictEqual(author, 'Confreaks');
    });
    ...
    it('returns the date_published', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.strictEqual(date_published, '2016-09-27T00:00:00.000Z');
    });
    ...
    it('returns the content', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.strictEqual(first13, 'Keynote by José Valim');
    });
  });
});
