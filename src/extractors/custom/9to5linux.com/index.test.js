  ...
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html = fs.readFileSync(
        './fixtures/9to5linux.com/1772404182459.html'
      );
    ...
    it('returns the lead_image_url', async () => {
      ...
      assert.strictEqual(
        lead_image_url,
        `https://9to5linux.com/wp-content/uploads/2025/11/ov.webp`
      );
    });
    ...
    it('returns the content', async () => {
      ...
      assert.strictEqual(
        first13,
        'OpenVPN 2.7 has been released today as the latest version of this virtual'
      );
    });
  });
});
